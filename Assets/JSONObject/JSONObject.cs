...
#pragma warning restore 219
	...
	public static bool HaveFieldAndNotNull(JSONObject k, string fieldName){
		return (k != null && k.HasField(fieldName) && k.GetField(fieldName) != null && k[fieldName].ToString() != "null");
